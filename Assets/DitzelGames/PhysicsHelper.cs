// Source: https://gist.github.com/ditzel/1f207c838f0023fcbd34c5c67955fd25
...
namespace Ditzelgames
{
    ...
    {
        public static void ApplyForceToReachVelocity(
            Rigidbody rigidbody, Vector3 velocity, float force = 1, ForceMode mode = ForceMode.Force)
        {
            ...
            // source: https://www.youtube.com/watch?v=h0NJK4mEIJU
        ...
        public static void ApplyTorqueToReachRPS(
            Rigidbody rigidbody, Quaternion rotation, float rps, float force = 1)
        {
