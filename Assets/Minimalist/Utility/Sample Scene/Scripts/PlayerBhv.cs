...
namespace Minimalist.Utility.SampleScene
{
    public class PlayerBhv : CharacterBhv
    {
        ...
        private IEnumerator LevelUp()
        {
            ...
            health.MaximumAmount += 25;

            health.Amount = health.MaximumAmount;

            mana.MaximumAmount += 50;
