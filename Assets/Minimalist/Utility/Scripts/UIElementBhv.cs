...
namespace Minimalist.Utility
{
    ...
    public abstract class UIElementBhv : MonoBehaviour
    {
        // Public properties
        public GameObject GameObject => _gameObject == null || !Application.isPlaying ? gameObject : _gameObject;
        public RectTransform RectTransform => _rectTransform == null || !Application.isPlaying ? GetComponent<RectTransform>() : _rectTransform;
